...
def play_intro_sound():
    pygame.mixer.init()
    pygame.mixer.music.load("/Users/saritasamuelalee/Documents/Sarita Lee--Passion Project - Python_Planner/Songs/Mickey Mouse Clubhouse - 2007.mp3")
...
def play_end_sound():
    pygame.mixer.init()
    pygame.mixer.music.load("/Users/saritasamuelalee/Documents/Sarita Lee--Passion Project - Python_Planner/Songs/Mickey Mouse Clubhouse - Hot Dogs.mp3")
    pygame.mixer.music.play()
...
def break_timer():
    ...
    "jk that was a rhetorical quesiton lets resume...")
    time.sleep(3)
...
time.sleep(60)
pygame.mixer.music.stop()
speak("Congrats you've made it through the whole list...Here's a breif summary of what we've done today: Average time spent on each task: {} Number of Tasks Completed: {}  Number of Total Tasks: {} Great work ! See ya real soon ! ".format(current_user.summary))
